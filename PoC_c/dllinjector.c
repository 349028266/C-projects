...
int main(void){
    ...
    if(Process32First(Snapshot, &pe32)){
        do {
            if (strcmp(pe32.szExeFile, "Notepad.exe") == 0) {
                ...
                char path[] = "C:\\Users\\brian\\Desktop\\c test\\C-projects\\PoC_c\\injection.dll";
    ...
    printf("\033[0;31m(-) Target process (notepad.exe) not found. Please start Notepad and try again.\033[0m\n");
    CloseHandle(Snapshot);
    return 0;
